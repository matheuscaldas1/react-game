...
export class Boot extends Scene {
    ...
    preload() {
        ...
        this.load.image("checkpointDireito", "./assets/Colision/CheckDireito.png")
        this.load.image("checkpointEsquerdo", "./assets/Colision/CheckEsquerdo.png")
        this.load.image("finish", "./assets/Colision/finish.png")
